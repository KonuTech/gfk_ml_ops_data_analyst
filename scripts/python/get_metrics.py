...
def get_CA(data_frame, column_to_group_by, column_to_count_acctuals, column_to_count_predictions):
    ...
    positive_counts_grouped_acctuals = counts_grouped_acctuals.loc[
        counts_grouped_acctuals[column_to_count_acctuals] == 1]

    counts_grouped_predictions = data_frame.groupby([column_to_group_by, column_to_count_predictions]) \
        .size() \
        .rename('count_grouped_predictions') \
        .reset_index() \
        .sort_values(by=column_to_group_by, ascending=False) \
        .set_index(column_to_group_by)

    positive_counts_grouped_predictions = counts_grouped_predictions.loc[
        counts_grouped_predictions[column_to_count_predictions] == 1]

    df = pd.merge(positive_counts_grouped_acctuals, positive_counts_grouped_predictions, left_index=True,
                  right_index=True)
    df['CA'] = df['count_grouped_acctuals'] / df['count_grouped_predictions']
...
def get_CR(data_frame, column_to_group_by, column_to_count_acctuals, column_to_count_predictions):
    ...
    negative_counts_grouped_acctuals = counts_grouped_acctuals.loc[
        counts_grouped_acctuals[column_to_count_acctuals] == 0]
    ...
    negative_counts_grouped_predictions = counts_grouped_predictions.loc[
        counts_grouped_predictions[column_to_count_predictions] == 0]

    df = pd.merge(negative_counts_grouped_acctuals, negative_counts_grouped_predictions, left_index=True,
                  right_index=True)
    df['CR'] = df['count_grouped_acctuals'] / df['count_grouped_predictions']
...
def get_DAR(data_frame, column_to_count_acctuals, column_to_count_predictions, column_to_group_by):
    ...
    data['AR'] = data['TP'] / data['count_grouped_predictions']
...
def get_DRR(data_frame, column_to_count_acctuals, column_to_count_predictions, column_to_group_by):
    ...
    data['RR'] = data['TN'] / data['count_grouped_predictions']
